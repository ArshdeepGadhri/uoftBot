...
public class courseCodeCommand extends Command {
    EventWaiter waiter;
    public courseCodeCommand(EventWaiter waiter){
        this.waiter = waiter;
        this.name = "code";
        this.aliases = new String[]{"c"};
        this.cooldown = 5;
        this.help = "Returns Course data by code";
    ...
    protected void execute(CommandEvent commandEvent) {
        if (commandEvent.getArgs().length()==0){
            commandEvent.reply("Missing args, you need to provide me with a course-code");
            return;
        }
            ...
            waiter.waitForEvent(MessageReactionAddEvent.class,
                    ...
                    event -> {
                        ...
                        try{
                            ...
                            HttpGet req = new HttpGet("https://nikel.ml/api/courses?code="+courseCode.replace(" ","%20")+camp.get());
